...
from Seismic_data_reconstruction.Model.BTN.UshapeNetwork import BTN as DSP
...
class TrainConfig:
    ...
    uniform_path = os.path.join(Base_path, 'Data', 'Mobil_AVO_viking_graben_line_12', 'AVO_DSP.npy')
    fkmask_path = None
